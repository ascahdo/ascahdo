<?php
/**
 * Template Name: Ascado Halal Marketplace
 * Description: Displays the Halal Marketplace hub directly within WordPress.
 *
 * @package Ascado
 * @version 1.0.0
 */
...
<script>
    window.ascadoDefaultView = 'marketplace';
</script>
...
<?php if ($embed_mode === 'iframe') : ?>
    <iframe
        ...
        src="<?php echo esc_url($cloud_url . '#marketplace'); ?>"
        ...
        loading="eager"
        title="Ascado Halal Marketplace"
    ></iframe>
<?php else : ?>
    <div id="root" style="min-height: 100vh; width: 100%;">
        <div style="min-height: 85vh; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: 'Hind Siliguri', -apple-system, BlinkMacSystemFont, sans-serif; text-align: center; padding: 40px 20px;">
            ...
            <h2 style="color: #047857; font-size: 22px; font-weight: 800; margin: 0 0 10px;">হালাল মার্কেটপ্লেস লোড হচ্ছে...</h2>
            <p style="color: #64748b; font-size: 15px; margin: 0 0 20px; max-width: 480px; line-height: 1.6;">খাঁটি মধু, কাঠের ঘানির তেল, প্রিমিয়াম সফটওয়্যার লাইসেন্স ও ইসলামিক পণ্য তালিকা প্রস্তুত হচ্ছে...</p>
        </div>
    </div>
<?php endif; ?>
</main>
