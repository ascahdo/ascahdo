<?php
/**
 * Template Name: Ascado Halal Matrimony
 * Description: Displays the Halal Marriage Media & Biodata portal directly within WordPress.
 *
 * @package Ascado
 * @version 1.0.0
 */
...
<script>
    window.ascadoDefaultView = 'marriage';
</script>
...
<?php if ($embed_mode === 'iframe') : ?>
    <iframe
        ...
        src="<?php echo esc_url($cloud_url . '#marriage'); ?>"
...
<?php else : ?>
    <div id="root" style="min-height: 100vh; width: 100%;">
        <div style="min-height: 85vh; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: 'Hind Siliguri', -apple-system, BlinkMacSystemFont, sans-serif; text-align: center; padding: 40px 20px;">
            <div style="width: 52px; height: 52px; border: 4px solid #fce7f3; border-top-color: #db2777; border-radius: 50%; animation: ascado-spin 0.8s linear infinite; margin-bottom: 20px;"></div>
            <h2 style="color: #db2777; font-size: 22px; font-weight: 800; margin: 0 0 10px;">হালাল বৈবাহিক মিডিয়া প্রস্তুত হচ্ছে...</h2>
            <p style="color: #64748b; font-size: 15px; margin: 0 0 20px; max-width: 480px; line-height: 1.6;">ভেরিফাইড পাত্র-পাত্রীর ইসলামিক বায়োডাটা ও সুরক্ষিত যোগাযোগ ব্যবস্থা...</p>
        </div>
    </div>
<?php endif; ?>
</main>
