<?php
/**
 * Template Name: Ascado Charity & Zakat Donation
 * Description: Displays the Islamic Charity, Zakat Calculator, and Donation Projects directly within WordPress.
 *
 * @package Ascado
 * @version 1.0.0
 */
...
<script>
    window.ascadoDefaultView = 'donation';
</script>
...
<?php if ($embed_mode === 'iframe') : ?>
    <iframe
        ...
        src="<?php echo esc_url($cloud_url . '#donation'); ?>"
...
<?php else : ?>
    <div id="root" style="min-height: 100vh; width: 100%;">
        <div style="min-height: 85vh; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: 'Hind Siliguri', -apple-system, BlinkMacSystemFont, sans-serif; text-align: center; padding: 40px 20px;">
            <div style="width: 52px; height: 52px; border: 4px solid #dcfce7; border-top-color: #16a34a; border-radius: 50%; animation: ascado-spin 0.8s linear infinite; margin-bottom: 20px;"></div>
            <h2 style="color: #16a34a; font-size: 22px; font-weight: 800; margin: 0 0 10px;">সাদাকাহ ও যাকাত পোর্টাল লোড হচ্ছে...</h2>
            <p style="color: #64748b; font-size: 15px; margin: 0 0 20px; max-width: 480px; line-height: 1.6;">স্বচ্ছ যাকাত ফান্ড, জরুরি ত্রাণ সহায়তা ও ১০০% সুরক্ষিত ডিজিটাল অনুদান গেটওয়ে...</p>
        </div>
    </div>
<?php endif; ?>
</main>
