<?php
/**
 * Main Template File for Ascado Theme
 *
 * @package Ascado
 * @version 1.0.0
 */
...
<?php if ($embed_mode === 'iframe') : ?>
    <!-- Full Cloud App Seamless Responsive Iframe -->
    <iframe
        ...
        loading="eager"
        title="Ascado Integrated Platform"
    ></iframe>
<?php else : ?>
    <!-- Native React App Mount Point -->
    <div id="root" style="min-height: 100vh; width: 100%;">
        <!-- Fast Skeleton Loader while React Bundle executes -->
